  ...
  <div class="row">
    <form id="cadVt" name="formvalendo" method="POST" action="busca.php"  >
      <article class="escolhaVideo col-lg-3">
        ...
        <section class="pass4 container-fluid passo4">
          <div class="row">
            <div class="containerForm">
              ...
              <div class="form-group col-md-6">
                <input type="text" name="caracteristicaDoProduto" id="caracProduto" placeholder="Características do produto" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorAvista" id="vlrAvistaProduto" placeholder="Valor do produto a vista" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorAprazo" id="vlrPrazo" placeholder="Valor do produto a prazo" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="formaPagamento" id="formaPagamento" placeholder="Forma de pagamento" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
        ...
        <h1 class="pass4 text-center"> OFERTA 2</h1>
        <section class="pass4 container-fluid passo4">
          <div class="row">
            <div class="containerForm">
              <!-- <form class="cadVt" name="oferta1"> -->
              <div class="form-group col-md-6">
                <input type="text" name="nomeDoProduto2" id="nmProduto" placeholder="Nome do Produto" class="txtoferta1 oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="caracteristicaDoProduto2" id="caracProduto" placeholder="Características do produto" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorAvista2" id="vlrAvistaProduto" placeholder="Valor do produto a vista" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorAprazo2" id="vlrPrazo" placeholder="Valor do produto a prazo" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="formaPagamento2" id="formaPagamento" placeholder="Forma de pagamento" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorEntrada2" id="vlrEntrada" placeholder="Valor de entrada" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorParcelas2" id="vlrParcelas" placeholder="Valor das parcelas" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="qtdParcelas2" id="qtdParcelas" placeholder="Quantidade de parcelas" class="oferta form-control">
              </div>
              <div class="form-group col-md-12">
                <textarea name="txtJuridico2" id="textoJuridico" placeholder="Texto Jurídico" class="oferta form-control" style="resize: none;" rows="6"></textarea>
              </div>
              <!-- </form> -->
            </div>
          </div>
        ...
        <h1 class="pass4 text-center"> OFERTA 3</h1>
        <section class="pass4 container-fluid passo4">
          <div class="row">
            <div class="containerForm">
              <!-- <form class="cadVt" name="oferta1"> -->
              <div class="form-group col-md-6">
                <input type="text" name="nomeDoProduto3" id="nmProduto" placeholder="Nome do Produto" class="txtoferta1 oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="caracteristicaDoProduto3" id="caracProduto" placeholder="Características do produto" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorAvista3" id="vlrAvistaProduto" placeholder="Valor do produto a vista" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorAprazo3" id="vlrPrazo" placeholder="Valor do produto a prazo" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="formaPagamento3" id="formaPagamento" placeholder="Forma de pagamento" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorEntrada3" id="vlrEntrada" placeholder="Valor de entrada" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="valorParcelas3" id="vlrParcelas" placeholder="Valor das parcelas" class="oferta form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="qtdParcelas3" id="qtdParcelas" placeholder="Quantidade de parcelas" class="oferta form-control">
              </div>
              <div class="form-group col-md-12">
                <textarea name="txtJuridico3" id="textoJuridico" placeholder="Texto Jurídico" class="oferta form-control" style="resize: none;" rows="6"></textarea>
              </div>
              <!-- </form> -->
            </div>
          </div>
        ...
        <section class="pass7 container-fluid">
          <div class="row">
            <div class="containerForm">
              <!-- <form class="cadVt"> -->
              <div class="form-group col-md-6">
                <input type="text" name="nomeEmpresa" placeholder="Nome da empresa" class="dadoEmpresa txtEmpresaDado form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="enderecoEmpresa" placeholder="Endereço" class="dadoEmpresa form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="telefoneEmpresa" placeholder="Telefone" class="dadoEmpresa form-control">
              </div>
              <div class="form-group col-md-6">
                <input type="text" name="sloganEmpresa" placeholder="Slogan" class="dadoEmpresa form-control">
              </div>
